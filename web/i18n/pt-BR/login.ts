const translation = {
  ...
  welcome: 'Bem-vindo ao Laiye, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Laiye, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Laiye',
  invalid: 'O link expirou',
  explore: 'Explorar o Laiye',
